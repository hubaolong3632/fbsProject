  ...
  <div class="panel-body">
   ...
   <form role="form" class="form-horizontal">
    ...
    <div class="form-group">
     ...
     <div class="col-sm-10">
      <textarea class="form-control autogrow" cols="5" id="essential" style="overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 50px; width: 100%;"></textarea>
     </div>
    </div>
    ...
    <div class="form-group">
     ...
     <div class="col-sm-10">
      <textarea class="form-control autogrow" cols="5" id="workexperience" style="overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 50px; width: 100%;"></textarea>
     </div>
    </div>
    ...
    <div class="form-group">
     ...
     <div class="col-sm-10">
      <textarea class="form-control autogrow" cols="5" id="representative" style="overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 50px; width: 100%;"></textarea>
     </div>
    </div>
    ...
    <div class="form-group">
     ...
     <div class="col-sm-10">
      <textarea class="form-control autogrow" cols="5" id="educational"  style="overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 50px; width: 100%;"></textarea>
     </div>
    </div>
    ...
    <div class="form-group">
     ...
     <div class="col-sm-10">
      <textarea class="form-control autogrow" cols="5" id="cn" style="overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 50px; width: 100%;"></textarea>
     </div>
    </div>
