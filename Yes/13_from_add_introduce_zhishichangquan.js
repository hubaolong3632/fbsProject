                ...
                <div class="mail-compose">
                    ...
                    <div class="mail-header">
                      <div class="row">
                        <div class="col-sm-6">
                          <h3>
                            <i class="linecons-pencil"></i><font _mstmutation="1" _msttexthash="11479338" _msthash="166">知识产权</font></h3>
                        </div>
    ...
    htmlMagic: async function (document1) {
       ...
       param.data.text =     editor.getHtml(); // 获取编辑器的内容 并且压缩成一行 内容
            ...
            document.getElementById("show_message").innerHTML=`
               <h2 class="text-center mb-4">知识产权模块修改</h2>
            <hr>
               <a class="btn btn-primary d-block mx-auto mb-3">知识产权模块模块修改完成</a>
            <hr>
            `;
